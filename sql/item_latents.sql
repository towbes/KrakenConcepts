...
-- Morana's Pigaches
-- -------------------------------------------------------
INSERT INTO `item_latents` VALUES  (11408,974,10,9,14);   -- Shiva MACC + 10
-- -------------------------------------------------------
-- Louhi's Mask
-- -------------------------------------------------------
...
-- Fenrir's Crown
-- -------------------------------------------------------
INSERT INTO `item_latents` VALUES            (11496,2022,5,9,9);     -- Fenrir acc + 5
-- -------------------------------------------------------
-- Aesir Mantle
-- -------------------------------------------------------
...
INSERT INTO `item_latents` VALUES  (13162,2,15,26,0);     -- Daytime: HP +10 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,5,15,26,1);     -- Nighttime: MP +10 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,8,7,28,0);      -- Firesday: STR +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,9,7,35,0);      -- Lightningsday: DEX +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,10,7,29,0);     -- Earthsday: VIT +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,11,7,31,0);     -- Windsday: AGI +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,12,7,34,0);     -- Iceday: INT +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,13,7,30,0);     -- Watersday: MND +5 (needs HQ stats)
INSERT INTO `item_latents` VALUES  (13162,14,7,36,0);     -- Lightsday: CHR +5 (needs HQ stats)
...
-- Sacrifice Torque
-- -------------------------------------------------------
INSERT INTO `item_latents` VALUES            (15528,404,8,21,21);   -- -8HP/Tic
INSERT INTO `item_latents` VALUES            (15528,369,-3,21,21);  -- -3MP/Tic
INSERT INTO `item_latents` VALUES            (15528,2021,10,21,21); -- Avatar: +3 ATT is hot garbage for the cost,bumping it up to 10.
-- -------------------------------------------------------
-- Berserker's Torque
-- -------------------------------------------------------
...
INSERT INTO `item_latents` VALUES  (15773,384,400,58,0);  -- Imperial Ring
...
-- NEED STATUS # INSERT INTO `item_latents` VALUES  (15955,421,2,13,740); -- critical hit damage 2% under status familiar (bst)
-- NEED STATUS # INSERT INTO `item_latents` VALUES  (15955,421,2,13,731); -- critical hit damage 2% under status mijin gakure (nin)
...
-- Karura Hachigane
-- -------------------------------------------------------
INSERT INTO `item_latents` VALUES  (16154,346,2,9,13);    -- Garuda Perp Cost - 2
INSERT INTO `item_latents` VALUES  (16154,2021,10,9,13);  -- Garuda ATT +10
INSERT INTO `item_latents` VALUES  (16154,2022,10,9,13);  -- Garuda ACC +10
...
INSERT INTO `item_latents` VALUES  (16893,1,10,70,0);     -- Reserve Captains Lance.
...
INSERT INTO `item_latents` VALUES  (17530,71,8,70,2);     -- Master Casters Pole
-- -------------------------------------------------------
...
INSERT INTO `item_latents` VALUES  (17617,1,10,70,2);    -- Master Casters Knife
-- -------------------------------------------------------
-- Daylight Dagger
-- -------------------------------------------------------
...
INSERT INTO `item_latents` VALUES  (17655,1,10,70,1);    -- Senior Musketeers Scimitar 
...
INSERT INTO `item_latents` VALUES  (17766,27,1,16,3);     -- Enmity +1~4
...
INSERT INTO `item_latents` VALUES  (17934,24,10,70,0);    -- Reserve Captains Pick
...
-- Leviathan's Couse
-- -------------------------------------------------------
-- INSERT INTO `item_latents` VALUES  (18109,431,1,21,12); -- TODO: Additional effect: Water damage while you or a party member has Leviathan summoned
...
INSERT INTO `item_latents` VALUES  (18609,23,2,16,2);     -- Lyft Pole
...
INSERT INTO `item_latents` VALUES  (18872,25,1,16,1);     -- Lyft Ferule
...
INSERT INTO `item_latents` VALUES  (19161,24,1,16,3);
INSERT INTO `item_latents` VALUES  (19161,24,1,16,4);
INSERT INTO `item_latents` VALUES  (19161,24,1,16,5);
INSERT INTO `item_latents` VALUES  (19161,24,1,16,6);
-- -------------------------------------------------------
-- Wurger
-- -------------------------------------------------------
