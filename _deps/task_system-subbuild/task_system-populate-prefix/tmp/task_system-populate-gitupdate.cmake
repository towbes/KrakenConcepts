...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/task_system-src"
...
execute_process(
  COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" show-ref "241acb039152b646589fcbbcfb4d8d8e5bddc815"
  WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/task_system-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/task_system-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/task_system-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
