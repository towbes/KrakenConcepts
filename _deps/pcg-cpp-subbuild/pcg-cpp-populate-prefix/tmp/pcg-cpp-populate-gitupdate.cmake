...
execute_process(
  COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" show-ref "428802d1a5634f96bcd0705fab379ff0113bcf13"
  WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/pcg-cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/pcg-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/pcg-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
