...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" show-ref "cd898904b72a300011fbb24d578620bafa08ef2c"
  WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "cd898904b72a300011fbb24d578620bafa08ef2c")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("cd898904b72a300011fbb24d578620bafa08ef2c" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/cd898904b72a300011fbb24d578620bafa08ef2c")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
...
execute_process(
  COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" status --porcelain
  WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" rebase --abort
      WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src'."
    ...
    execute_process(
      COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    )
    execute_process(
      COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" stash pop --quiet
      WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
      )
      execute_process(
        COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/Users/Chris/AppData/Local/Atlassian/SourceTree/git_local/bin/git.exe" submodule update --recursive --init 
    WORKING_DIRECTORY "C:/Users/Chris/Desktop/CactuarLSB/server/_deps/recastnavigation-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
