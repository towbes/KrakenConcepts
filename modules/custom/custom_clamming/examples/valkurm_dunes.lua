...
clamming.zones[xi.zone.VALKURM_DUNES] =
{
...
m:addOverride("xi.zone.Valkurm_Dunes.Zone.onInitialize", function(zone)
    super(zone)
...
m:addOverride("xi.zone.Valkurm_Dunes.Zone.onZoneIn", function(player, zonePrev)
    super(player, zonePrev)
    clamming.onZoneIn(player)
end)

m:addOverride("xi.zone.Valkurm_Dunes.Zone.onZoneOut", function(player)
    super(player)
