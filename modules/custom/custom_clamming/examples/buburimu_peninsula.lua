...
clamming.zones[xi.zone.BUBURIMU_PENINSULA] =
{
...
m:addOverride("xi.zone.Buburimu_Peninsula.Zone.onInitialize", function(zone)
    super(zone)
...
m:addOverride("xi.zone.Buburimu_Peninsula.Zone.onZoneIn", function(player, zonePrev)
    super(player, zonePrev)
    clamming.onZoneIn(player)
end)

m:addOverride("xi.zone.Buburimu_Peninsula.Zone.onZoneOut", function(player)
    super(player)
