...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    ...
    params.ftp100 = 2 params.ftp200 = 3.25 params.ftp300 = 5
    -- wscs are in % so 0.2=20%
    params.str_wsc = 0.5 params.dex_wsc = 0.0 params.vit_wsc = 0.25 params.agi_wsc = 0.0 params.int_wsc = 0.25 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
