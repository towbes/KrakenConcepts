...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    ...
    if damage > 0 then
        ...
        target:addStatusEffect(xi.effect.MAGIC_DEF_DOWN, 1, 0, duration)
        player:messagePublic(xi.msg.basic.ROLL_SUB, target, wsID, xi.effect.MAGIC_DEF_DOWN)
        target:addStatusEffect(xi.effect.MAGIC_EVASION_DOWN, 1, 0, duration)
        player:messagePublic(xi.msg.basic.ROLL_SUB, target, wsID, xi.effect.MAGIC_EVASION_DOWN)
