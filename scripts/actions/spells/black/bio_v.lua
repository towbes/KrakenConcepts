...
spellObject.onSpellCast = function(caster, target, spell)
    ...
    local dotdmg = 9 + math.floor(caster:getSkillLevel(xi.skill.DARK_MAGIC) / 60)

    -- Do it!
    target:addStatusEffect(xi.effect.BIO, dotdmg, 3, duration, 0, 30, 4)
