...
zones[xi.zone.SPIRE_OF_HOLLA] =
{
    text =
    {
        ...
        NO_BATTLEFIELD_ENTRY          = 7092, -- You can hear a faint scraping sound from within, but the way is barred by some strange membrane...
        ...
        ENTERING_THE_BATTLEFIELD_FOR  = 7616, -- Entering the battlefield for [Ancient Flames Beckon/Simulant/Empty Hopes]!
