...
xi = xi or {}
xi.nyzul_isle_data = xi.nyzul_isle_data or {}

xi.nyzul_isle_data.mobType =
{
...
xi.nyzul_isle_data.objectiveType = {
...
xi.nyzul_isle_data.subObjectiveType = {
    "DO_NOT_DESTROY_GEARS",
    "AVOID_DECTECTION_BY_GEARS"
}

xi.nyzul_isle_data.maps = {
    "NORTH_EAST",
    "EAST",
    "CENTRAL",
    "SOUTH_EAST",
...
-- uses xi.job values for key value (see status.lua)
xi.nyzul_isle_data.jobToVigilWeaponMap = {
...
xi.nyzul_isle_data.bossFloorTableKeys = {
    "BOSS_ROOM_1",
    "BOSS_ROOM_2",
    "BOSS_ROOM_3",
    "BOSS_ROOM_4"
...
xi.nyzul_isle_data.bossFloorLayouts =
{
...
xi.nyzul_isle_data.northEastFloorTableKeys = {
    "FLOOR_NE_1",
    "FLOOR_NE_2",
    "FLOOR_NE_3",
    "FLOOR_NE_4",
...
xi.nyzul_isle_data.northEastFloorLayouts =
{
...
xi.nyzul_isle_data.eastFloorTableKeys = {
    "FLOOR_EAST_1",
    "FLOOR_EAST_2",
    "FLOOR_EAST_3",
    "FLOOR_EAST_4",
...
xi.nyzul_isle_data.eastFloorLayouts =
{
...
xi.nyzul_isle_data.centralFloorTableKeys = {
    "FLOOR_CENTRAL_1",
    "FLOOR_CENTRAL_2",
    "FLOOR_CENTRAL_3",
    "FLOOR_CENTRAL_4",
...
xi.nyzul_isle_data.centralFloorLayouts =
{
...
xi.nyzul_isle_data.southEastFloorTableKeys = {
    "FLOOR_SE_1",
    "FLOOR_SE_2",
    "FLOOR_SE_3",
    "FLOOR_SE_4",
...
xi.nyzul_isle_data.southEastFloorLayouts =
{
...
xi.nyzul_isle_data.southFloorTableKeys = {
    "FLOOR_SOUTH_1",
    "FLOOR_SOUTH_2",
    "FLOOR_SOUTH_3",
    "FLOOR_SOUTH_4",
...
xi.nyzul_isle_data.southFloorLayouts =
{
...
xi.nyzul_isle_data.southWestFloorTableKeys = {
    "FLOOR_SW_1",
    "FLOOR_SW_2",
    "FLOOR_SW_3",
    "FLOOR_SW_4",
...
xi.nyzul_isle_data.southWestFloorLayouts =
{
    FLOOR_SW_1 = { -- North
...
xi.nyzul_isle_data.roomConfigurations = {
